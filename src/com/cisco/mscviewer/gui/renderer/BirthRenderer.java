...
public class BirthRenderer extends EventRenderer {
    ...
    public void render(Graphics2D g2d, Dimension maxDim) {
        ...
        final int x1 = 0 - TRIANGLE_BASE / 2;
        final int x2 = 0 + TRIANGLE_BASE / 2;
        final int x3 = 0;
        final int y1 = 0 - TRIANGLE_BASE / 2;
        final int y2 = 0 - TRIANGLE_BASE / 2;
        final int y3 = 0 + TRIANGLE_BASE / 2;
