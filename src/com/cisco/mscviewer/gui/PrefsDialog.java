...
PropertyChangeListener {
    ...
    public  PrefsDialog(JFrame aFrame, long initTimeFactor, OutputUnit abs, InputUnit delta) {
        super(aFrame, true);
        ...
        int i=0;
        for(InputUnit unit: InputUnit.values()) {
        ...
        i=0;
        for(OutputUnit unit: OutputUnit.values()) {
        ...
        Object[] array = {inputP, outputP, eventP};
    ...
    public void setInputUnit(InputUnit timestampUnit) {
        for (JRadioButton inputChoice1 : inputChoice) {
    ...
    public void setAbsoluteOutputUnit(OutputUnit absTimeUnit) {
        for (JRadioButton outputChoice1 : outputChoice) {
